...
class LiquidCrystalRus_I2C_Esp32 : public Print {
  public:
    LiquidCrystalRus_I2C_Esp32(uint8_t lcd_Addr, uint8_t lcd_cols, uint8_t lcd_rows);
    void begin();
    void clear();
    void home();
